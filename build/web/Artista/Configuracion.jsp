                    ...
                    <div class="card">
                            <div class="card shadow mb-5 bg-body rounded">
                                <div class="card-body">
                                    ...
                                    <form action="Mv_Usuarios?menu=Perfil&accion=Actualizar&id=${Art.getIdUsuario()}&name=${Art.getNombreUsuario()}&alias=${Art.getPseudonombre()}&correo=${Art.getCorreoUsuario()}&tel=${Art.getTelefono()}" method="post" enctype="multipart/form-data" >
                                        <div class="container">
                                            <div class="mb-3">
                                                ...
                                                <div class="d-grid gap-2 col-3 mx-auto">
                                                    <div class="row">
                                                        <div class="col-md-5 col-sm-2">
                                                             <!-- Input y nombre -->
                                                            <div class="espaci">
                                                                <input type="hidden" name="id_usu" value="${Art.getIdUsuario()}">
                                                                <label style="color: #00AD00;" >Nombre</label>
                                                                <input type="text" class="form-control" id="nombre" placeholder="Nombre del artista" value="${Art.getNombreUsuario()}">
                                                            </div>
                                                            <div class="espaci">
                                                                <label style="color: #00AD00;" >Correo</label>
                                                                <input type="email" class="form-control" id="correo" placeholder="Correo electrónico" value="${Art.getCorreoUsuario()}">
                                                            </div>
                                                            <div class="espaci">
                                                                <label style="color: #00AD00;" >Pseudonombre</label>
                                                                <input type="text" class="form-control" id="Pseudonombre" placeholder="Pseudonombre" value="${Art.getPseudonombre()}">
                                                            </div>
                                                            <div class="espaci">
                                                                <label style="color: #00AD00;" >Teléfono</label>
                                                                <input type="text" class="form-control" id="nequi" placeholder="Cuenta de pago" value="${Art.getTelefono()}">
                                                            </div>
                                                        </div>
