...
<html>
    ...
    <link rel="stylesheet" href="Comprador/StylesComprador/inicio_comprador.css">
    <link rel="stylesheet" href="Comprador/StylesComprador/encabezado.css">
    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container-fluid"  style="background: #00AD00;">
            <div>
                <a class="navbar-brand d-none d-md-block text-light" href="/9_Mi_perfil/Mi_perfil.html">
                    <img src="Comprador/Iconos/perfil.png" alt="" style=" width: 30px; height: 30px;" class="d-inline-block">
                    Biblioarte
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse pe-5" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="/Comprador/inicio_comprador.jsp"><img class="icon" src="Comprador/Iconos/Inicio.png"> Inicio</a></li>
